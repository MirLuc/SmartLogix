...
public class DataSeedConfig {
    ...
    CommandLineRunner seedUsers(
            ...
            @Value("${smartlogix.seed.order-password:order123}") String orderPassword,
        ...
        return args -> {
            if (userRepository.count() == 0) {
                ...
                order.setEmail("order@smartlogix.com");
                order.setPassword(passwordEncoder.encode(orderPassword));
                order.setRole(Role.ROLE_ORDER);
